...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置：合约管理&nbsp; > &nbsp;租户合约</td>
    </tr>
    <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
                <tr>
                    <td width="90%" align="left" valign="middle">
                        ...
                        <a name="" type="button"  class="history-but" href="tenant_history_contract.jsp" ><span style="margin-left: 4px;">历史合约</span></a>
                    </td>
                    <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="add_tenant_contract.jsp" target="mainFrame" onFocus="this.blur()" class="add">新增合约</a></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td align="left" valign="top" class="fenye"> &nbsp;&nbsp;
        	<a href="#" onclick="showTContract(${pageinfo.firstPage})"  target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;
	        <c:if test="${pageinfo.hasPreviousPage}">
	        <a href="#"onclick="showTContract(${pageinfo.prePage})" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;
	        </c:if>
	        ${pageinfo.pageNum}/${pageinfo.pages} 页&nbsp;&nbsp;
	        <c:if test="${pageinfo.hasNextPage}">
	        <a href="#"onclick="showTContract(${pageinfo.nextPage})" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;
	        </c:if>
	        <a href="#" onclick="showTContract(${pageinfo.lastPage})" target="mainFrame" onFocus="this.blur()">尾页</a>
        </td>
    </tr>
</table>
</body>
