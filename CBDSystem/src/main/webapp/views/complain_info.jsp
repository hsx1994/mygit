...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
        ...
        <td align="left" valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                ...
                <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                    ...
                    <td align="center" valign="middle" class="borderbottom"><a href="complain_details.jsp" target="mainFrame" onFocus="this.blur()" class="add">受理</a></td>
                </tr>
                <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                    <td align="center" valign="middle" class="borderright borderbottom">admin</td>
                    <td align="center" valign="middle" class="borderright borderbottom">创始人</td>
                    <td align="center" valign="middle" class="borderright borderbottom">2013-04-26 11:00</td>
                    <td align="center" valign="middle" class="borderbottom"><a href="complain_details.jsp" target="mainFrame" onFocus="this.blur()" class="add">受理</a></td>
                </tr>
    ...
    <tr>
        ...
        <a href="list?page=${pageinfo.lastPage}" target="mainFrame" onFocus="this.blur()">尾页</a></td>
    </tr>
