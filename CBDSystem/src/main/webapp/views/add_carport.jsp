...
<head>
    ...
    <style>
        ...
        #addinfo a{ font-size:14px; font-weight:bold; background:url(../images/main/addinfoblue.jpg) no-repeat 0 1px; padding:0px 0 0px 20px; line-height:45px;}
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    ...
    <tr>
        <td align="left" valign="top" id="addinfo">
            <a href="batch_add_carport.jsp" target="mainFrame" onFocus="this.blur()" class="add">批量添加</a>
        </td>
    </tr>
    <tr>
