...
<title>车位展示</title>
<link type="text/css" href="/CBDSystem/parking/css/css1.css" rel="stylesheet" />
<script type="text/javascript" src="/CBDSystem/parking/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="/CBDSystem/parking/js/js.js"></script>
</head>
...
<!-- <body > -->
	...
	<div class="mid">
		<h1 class="logo" style="text-align:left;">
			<a href="index.html"><img src="/CBDSystem/images/parking/images/logo.png" width="304"
				height="74" /></a>
		</h1>
		<form action="#" method="get" class="subBox">
			<div class="subBox2">
				<input type="text" class="subText" /> <input type="image"
					src="/CBDSystem/images/parking/images/sub.jpg" width="95" height="32" class="subImg" />
				<div class="hotci">
		...
		<div class="ding-gou">
			<div class="ding">
				<a href="order.html"><img src="/CBDSystem/images/parking/images/dingdan.jpg" width="106"
					height="32" /></a>
			</div>
			<!--ding/-->
			<div class="gou">
				<a href="car.html"><img src="/CBDSystem/images/parking/images/gouwuche.jpg" width="126"
					height="32" /></a>
			</div>
			<!--gou/-->
			<div class="clears"></div>
	...
	<form action="#" method="get" class="proDingzhi">
		<img src="/CBDSystem/images/parking/images/dingzhi.jpg" width="972" height="167" />
				...
				<td>
					<div class="proPosition">
						...
						<div class="jiage">
							...
							<input type="image" src="/CBDSystem/images/parking/images/queding.png" class="queen" />
						</div>
						<!--jiage/-->
					</div>
				</td>
...
<!-- ***************************************** 分页部分 *****************************************************-->
					<div class="page">
						<div  class="content-bottom-paging"><a href="#" onclick="upCurrentPage(${paging.lastPage})">末页</a></div>
						<div  class="content-bottom-paging"><a target="mainFrame" href="#" onclick="upCurrentPage(${paging.nextPage})">下一页</a></div>
						<div id="page" class="content-bottom-paging"><span id="currentPage">${paging.pageNum}</span>/<span id="tolPage">${paging.pages}</span></div>
						<div  class="content-bottom-paging"><a href="#" onclick="upCurrentPage(${paging.prePage})">上一页</a></div>
						<div  class="content-bottom-paging"><a href="#" onclick="upCurrentPage(${paging.firstPage})">首页</a></div>
					</div>
			
			
			<!-- <dl>
				<dt>
					<a href="buyinfo.html"><img src="images/phone4.png" /></a>
				</dt>
				<dd>
					<h3>￥4800.00</h3>
					...
					<div class="jiaru-shoucang">
						<span class="jiaruCar">加入购物车</span> <span class="shoucangCar"><a
							href="quanjing/index.html">选用此模型</a></span>
						<div class="clears"></div>
					</div>
					jiaru-shoucang/
				</dd>
			...
			<dl>
				<dt>
					<a href="buyinfo.html"><img src="images/phone3.png" /></a>
				</dt>
				<dd>
					<h3>￥4800.00</h3>
					<div class="phonePars">Apple 苹果 iPhone 5s 16G
			...
			<dl>
				<dt>
					<a href="buyinfo.html"><img src="images/phone2.png" /></a>
				</dt>
				<dd>
					<h3>￥4800.00</h3>
					<div class="phonePars">Apple 苹果 iPhone 5s 16G
			...
			<dl>
				<dt>
					<a href="buyinfo.html"><img src="images/phone1.png" /></a>
				</dt>
				<dd>
					<h3>￥4800.00</h3>
					<div class="phonePars">Apple 苹果 iPhone 5s 16G
			...
			<dl>
				<dt>
					<a href="buyinfo.html"><img src="images/phone5.png" /></a>
				</dt>
				<dd>
					<h3>￥4800.00</h3>
					<div class="phonePars">Apple 苹果 iPhone 5s 16G
	...
	<div class="footBox">
		<div class="footers">
			<div class="footersLeft">
				<a href="index.html"><img src="/CBDSystem/images/parking/images/ftlogo.jpg" width="240"
					height="64" /></a>
