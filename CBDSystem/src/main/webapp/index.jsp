...
<body onload="upCurrentPage(1)">
	...
	<div class="proDingzhi">
		...
		<table class="proDSel">
			...
			<tr>
				...
				<td>&nbsp;&nbsp;车位序号：<input type="text" name="num"  id="num" />&nbsp;&nbsp;&nbsp;
					<button onclick="upNum(1)">提交</button>
				</td>
			...
			<tr>
				...
				<td>&nbsp;&nbsp;时间区间：<input id="time1" class="Wdate"
					type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />--&nbsp;<input id="time2"
		...
		<div id="showparking" class="phoneBox">
			...
			<!-- ***************************************** 分页部分 *****************************************************-->
			<!--隐藏总页数数据  -->
			<input id="lasth" type="hidden" value="${paging.lastPage}">
			<!--隐藏下一页页数  -->
			<input id="nexth" type="hidden" value="${paging.nextPage}">
			<!--隐藏上一页页数  -->
			<input id="preh" type="hidden" value="${paging.prePage}">



			<div class="page">
				<div class="content-bottom-paging">
					<a id="last" href="#" onclick="">末页</a>
				</div>
