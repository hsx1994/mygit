...
<li><a href="#" class="lan"></a></li>
 ...
 <div class="navBox navBg3">
  <ul class="nav">
   <li><a href="/CBDSystem/jsp/two.jsp">首页</a></li>
   <li><a href=""></a></li>
   <li><a href=""></a></li>
   <li><a href="/CBDSystem/jsp/two.jsp">用户中心</a></li>
   <li><a href=""></a></li>
   <li><a href=""></a></li>
   <li><a href=""></a></li>
   <div class="clears"></div>
  ...
  <div class="vipLeft">
   ...
   <dl class="vipNav">
    <dt class="vip_1">用户中心</dt>
     <dd><a href="/CBDSystem/jsp/LookTwoCar.jsp">查看上架车位</a></dd>
     <dd><a href="vipShoucang.html"></a></dd>
    <dt class="vip_2">个人中心</dt>
     <dd class="ddCur"><a href="/CBDSystem/jsp/two.jsp">个人信息</a></dd>
     <dd><a href="/CBDSystem/jsp/RentUser.jsp">修改个人信息</a></dd>
     <dd><a href="/CBDSystem/jsp/LookTwoUser.jsp">查看租赁记录</a></dd>
    <dt class="vip_3"></dt>
