...
<div class="menu">
	<ul class="clearfix">
		<li class="current"><a href="http://sc.chinaz.com/">个人信息</a></li>
		<li><a href="jsp/RobRentUser.jsp">修改个人信息</a></li>
		<li><a href="http://sc.chinaz.com/">查看交易历史</a></li>
		<li><a href="http://sc.chinaz.com/">查看可租车位</a></li>
		<li><a href="http://sc.chinaz.com/">车位招租信息</a></li>
		<li><a href="http://sc.chinaz.com/">查看已租车位信息</a></li>
