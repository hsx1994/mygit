		...
		<div class="total">
			...
			<div class="mian">
				<div class="content-top">
							...
							<div class="parking">
								...
								<div class="prod-inner">
									<span class="price">${parking.price}元/小时</span> <a
										onclick="getId();" href="/CBDSystem/landladyshowOne.do?id=1" class="button" rel="nofollow">查看该车位</a>
									<div class="clear"></div>
								</div>
							</div>
					...
					<div class="page">
						<div id="" class="content-bottom-paging"><a href="/CBDSystem/showme.do?page=${paging.lastPage}">末页</a></div>
						<div id="" class="content-bottom-paging"><a href="/CBDSystem/showme.do?page=${paging.nextPage}">下一页</a></div>
						<div id="page" class="content-bottom-paging"><span id=currentPage>${paging.pageNum}</span>/<span id="tolPage">${paging.pages}</span></div>
						<div id="" class="content-bottom-paging"><a href="/CBDSystem/showme.do?page=${paging.prePage}">上一页</a></div>
						<div id="" class="content-bottom-paging"><a href="/CBDSystem/showme.do?page=1">首页</a></div>
					</div>
...
<!-- 引入外部js文件 -->
<script type="text/javascript" src="063/js/ShowLandladyParking.js"></script>
</html>
